...
def main():
    try:
        ...
        metrics = {
            ...
            'precision (Of all the loans we predicted would default, what percentage actually defaulted)': precision_score(y_test, y_pred),
            'recall (Of all the loans that actually defaulted, what percentage did we catch)': recall_score(y_test, y_pred),
